/* src/config/konjungate-config.h.  Generated from konjungate-config.h.in by configure.  */
/* src/config/konjungate-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef KONJ_CONFIG_H

#define KONJ_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/konjungatecoin/konjungate/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Konjungate Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Konjungate Core 2.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "konjungatecore"
