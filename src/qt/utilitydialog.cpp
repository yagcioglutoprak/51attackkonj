    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Konjungate Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Konjungate Core"));
...
All the Konjungate in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 KONJ, 0.1 KONJ, 1 KONJ and 10 KONJ -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Konjungate Core is shutting down...") + "<br /><br />" +
