    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("KONJ-light"), QVariant("light"));
    ui->theme->addItem(QString("KONJ-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("KONJ-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("KONJ-traditional"), QVariant("trad"));
