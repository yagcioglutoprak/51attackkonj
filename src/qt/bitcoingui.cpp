    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Konjungate Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Konjungate address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and konjungate: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Konjungate Core"), this);
    aboutAction->setStatusTip(tr("Show information about Konjungate Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Konjungate Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Konjungate addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Konjungate addresses"));
    ...
    openAction->setStatusTip(tr("Open a konjungate: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Konjungate Core help message to get a list with possible Konjungate Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Konjungate Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Konjungate Core"); // default title
    ...
    // Append title to "Konjungate Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
