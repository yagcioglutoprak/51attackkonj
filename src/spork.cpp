...
{
    if(fLiteMode) return; // disable all Konjungate specific functionality
...
bool CSporkManager::IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        switch (nSporkID) {
            ...
            case SPORK_15_CHARITY_PAYMENT_ENFORCEMENT:     r = SPORK_15_CHARITY_PAYMENT_ENFORCEMENT_DEFAULT; break;
            default:
...
int64_t CSporkManager::GetSporkValue(int nSporkID)
{
    ...
    switch (nSporkID) {
        ...
        case SPORK_15_CHARITY_PAYMENT_ENFORCEMENT:     return SPORK_15_CHARITY_PAYMENT_ENFORCEMENT_DEFAULT;
        default:
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_15_CHARITY_PAYMENT_ENFORCEMENT")     return SPORK_15_CHARITY_PAYMENT_ENFORCEMENT_DEFAULT;
