...
2. run konjungated with -printalert or -sendalert like this:
   /path/to/konjungated -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.konjungate.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Konjungate Core:0.12.0.58/"));
