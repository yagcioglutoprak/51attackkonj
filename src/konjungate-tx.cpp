...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Konjungate Core konjungate-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  konjungate-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded konjungate transaction") + "\n" +
              "  konjungate-tx [options] -create [commands]   " + _("Create hex-encoded konjungate transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded konjungate transaction
