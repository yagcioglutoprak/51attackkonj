...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "KonjungateNetwork") type = KonjungateNetwork;
    if(strType == "KonjungateNetworkVariable") type = KonjungateNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == KonjungateNetwork) s = "KonjungateNetwork";
    if(type == KonjungateNetworkVariable) s = "KonjungateNetworkVariable";
