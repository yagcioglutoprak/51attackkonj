 ...
 *
 *   // network
 *   CKonjungateNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.konjungate.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CKonjungateNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CKonjungateNetwork(UniValue objIn)
    {
...
// // can be under: KonjungateNetwork
// //   -- signature requirements : Key1(User)
// class CKonjungateNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == KonjungateNetwork);
//     // }
