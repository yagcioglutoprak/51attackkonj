...
Only requiring some minor changes is konjungate.cpp.
...
Changes to konjungate.cpp
----------------------
konjungate.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
