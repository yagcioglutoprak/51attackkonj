...
Konjungate Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Konjungate Core, where everyone uses
...
pay attention to for reviewers of Konjungate Core code.

General Konjungate Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Konjungate Core uses tinyformat, which is type safe. Leave them out to avoid confusion
