...
!define COMPANY "Konjungate Core project"
...
!else
InstallDir $PROGRAMFILES\BanqCore
!endif
CRCCheck on
XPStyle on
BrandingText " "
...
VIAddVersionKey ProductName "Konjungate Core"
...
Section -Main SEC0000
    ...
    # Remove old wxwidgets-based-konjungate executable and locales:
    Delete /REBOOTOK $INSTDIR\konjungate.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\konjungate-qt.exe
    ...
    WriteRegStr HKCR "konjungatecore" "URL Protocol" ""
    WriteRegStr HKCR "konjungatecore" "" "URL:Konjungate"
    WriteRegStr HKCR "konjungatecore\DefaultIcon" "" $INSTDIR\konjungate-qt.exe
    WriteRegStr HKCR "konjungatecore\shell\open\command" "" '"$INSTDIR\konjungate-qt.exe" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\konjungate-qt.exe
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMSTARTUP\Konjungate.lnk"
    ...
    DeleteRegKey HKCR "konjungatecore"
